...
function acceso() {
    ...
    if(correo == micorreo && clave == miclave){
        ...
        <a href="#" data-bs-toggle="modal" data-bs-target="#logout" alt="perfil" width="100" height="100">
            <img src="images/log-out-g941e9a8fe_1280.png" alt="Desconectar" width="30" height="24" title="Salir">
        </a>
        `
...
function desconectar(){
    ...
    <a href="#" data-bs-toggle="modal" data-bs-target="#login"  alt="perfil" width="100" height="100">
        <img src="images/person.svg" alt="Login" width="30" height="24" title="Conectar" class="bootstrap-icons bg-white">
    </a>
    `
